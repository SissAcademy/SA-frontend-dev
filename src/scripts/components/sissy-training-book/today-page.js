...
class DailyCommitments extends React.Component
{
    constructor(props)
    {
        super(props);
    ...
    render()
    {
        ...
        return(
            <section className={'commitments-daily'}>
                <h3>daily commitments</h3>
                <section className={'commitments-daily__mandatory'}>
                    <h4>mandatory</h4>
                    <span className={'commitments-daily__remaining'}>0 remaining</span>
                    <ul className={'commitments-daily__list'}>
                        <li className={'commitments-daily__list-item'}>
                            <p>Shower routine</p>
                            <button>Begin</button>
                            <button>Postpone</button>
                        </li>
                        <li className={'commitments-daily__list-item'}></li>
                        <li className={'commitments-daily__list-item'}></li>
                        <li className={'commitments-daily__list-item'}></li>
                    </ul>
                </section>
